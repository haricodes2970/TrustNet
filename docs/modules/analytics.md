...
Combined suite: **386/386 passing** (`npm run test:all`), **136/136 unit-only** (`npm test`), no regressions in any prior module (Marketplace's 369 carried forward unchanged).
